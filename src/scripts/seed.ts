...
if (!MONGODB_URI) {
  console.error(
    '❌ Error: MONGODB_URI is not defined in the environment or .env file!',
  );
  process.exit(1);
}
...
const categoriesData = [
  ...
  },
  {
    ...
    description:
      'Aromatically spiced long-grain rice dishes cooked to perfection.',
    color: '#FFF9E6',
    sortOrder: 3,
    isActive: true,
  },
  ...
  },
  {
    ...
    description:
      'Stir-fried noodles, dim sums, manchurian, and flavorful broths.',
    color: '#FFF1F0',
    sortOrder: 8,
    isActive: true,
  },
  {
    name: 'Rolls & Wraps',
    image:
      'https://images.unsplash.com/photo-1626700051175-6518c4793f4f?auto=format&fit=crop&q=80&w=400',
  ...
  },
  {
    ...
    description:
      'Nutritious salads, protein-packed bowls, and guilt-free meals.',
    color: '#F6FFED',
    sortOrder: 10,
    isActive: true,
  },
...
const cuisinesData = [
  {
    name: 'Indian',
    description:
      'A celebration of diverse regional flavors, aromatic spices, and rich culinary heritage.',
    image:
      'https://images.unsplash.com/photo-1585938338392-50a59970d8ee?auto=format&fit=crop&q=80&w=400',
  ...
  },
  {
    name: 'Italian',
    description:
      'Simple, high-quality ingredients like olive oil, fresh tomatoes, cheese, and pasta.',
    image:
      'https://images.unsplash.com/photo-1498579150354-97050a2bb596?auto=format&fit=crop&q=80&w=400',
  ...
  },
  {
    name: 'Chinese',
    description:
      'Balanced flavors of sweet, sour, salty, bitter, and umami using fresh stir-fries and steaming.',
    image:
  ...
  },
  {
    name: 'Mexican',
    description:
      'Bold and vibrant flavors with ingredients like corn, beans, chili peppers, and fresh avocados.',
    image:
  ...
  },
  {
    name: 'Japanese',
    description:
      'Artistry in food focusing on fresh seafood, rice, delicate seasoning, and elegant presentation.',
    image:
  ...
  },
  {
    name: 'Continental',
    description:
      'European culinary traditions featuring roasted meats, creamy sauces, and baked delicacies.',
    image:
  ...
  },
  {
    name: 'Middle Eastern',
    description:
      "Aromatic dishes with olive oil, chickpeas, lamb, and rich spices like sumac and za'atar.",
    image:
      'https://images.unsplash.com/photo-1547058881-aa0edd92aab3?auto=format&fit=crop&q=80&w=400',
